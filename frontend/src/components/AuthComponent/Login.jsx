...
import googleLogo from "/src/assets/images/auth/googleLogo.png";
import kakaoLogo from "/src/assets/images/auth/kakaoLogoB.png";
import naverLogo from "/src/assets/images/auth/naverLogo.png";
...
const Login = () => {
  ...
  return (
    <div
      className="bg-opacity-30 bg-black w-full h-screen p-5
    ...
    >
      ...
      >
        ...
        <button className="font-['pixel'] p-2 m-1 rounded w-72 bg-purple5">로그인</button>
